document.querySelector( 'form[name="sign_up"]').addEventListener( 'submit', function(e) {
    ...
    let user_email_temp = document.querySelector( 'input[name="user_email"]').value;
    ...
    .catch(error => console.error( 'sign_up fetch Error:', error));
